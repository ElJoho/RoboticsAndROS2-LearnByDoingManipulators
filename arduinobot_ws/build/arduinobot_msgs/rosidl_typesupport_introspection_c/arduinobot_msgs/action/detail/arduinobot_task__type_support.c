...
static rosidl_typesupport_introspection_c__MessageMember arduinobot_msgs__action__ArduinobotTask_Goal__rosidl_typesupport_introspection_c__ArduinobotTask_Goal_message_member_array[1] = {
  {
    "task_number",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, arduinobot_msgs, action, ArduinobotTask_SendGoal)() {
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_arduinobot_msgs
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, arduinobot_msgs, action, ArduinobotTask_GetResult)() {
