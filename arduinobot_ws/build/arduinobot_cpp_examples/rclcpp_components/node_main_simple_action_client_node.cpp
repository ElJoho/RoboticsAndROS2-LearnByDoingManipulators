...
#define NODE_MAIN_LOGGER_NAME "simple_action_client_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libsimple_action_client.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<arduinobot_cpp_examples::SimpleActionClient>";
