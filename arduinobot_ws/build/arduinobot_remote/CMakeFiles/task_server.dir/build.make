...
CMAKE_SOURCE_DIR = /home/joho/Documents/RoboticsAndROS2-LearnByDoingManipulators/arduinobot_ws/src/arduinobot_remote

# The top-level build directory on which CMake was run.
CMAKE_BINARY_DIR = /home/joho/Documents/RoboticsAndROS2-LearnByDoingManipulators/arduinobot_ws/build/arduinobot_remote
...
CMakeFiles/task_server.dir/src/task_server.cpp.o: /home/joho/Documents/RoboticsAndROS2-LearnByDoingManipulators/arduinobot_ws/src/arduinobot_remote/src/task_server.cpp
CMakeFiles/task_server.dir/src/task_server.cpp.o: CMakeFiles/task_server.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/joho/Documents/RoboticsAndROS2-LearnByDoingManipulators/arduinobot_ws/build/arduinobot_remote/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object CMakeFiles/task_server.dir/src/task_server.cpp.o"
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -MD -MT CMakeFiles/task_server.dir/src/task_server.cpp.o -MF CMakeFiles/task_server.dir/src/task_server.cpp.o.d -o CMakeFiles/task_server.dir/src/task_server.cpp.o -c /home/joho/Documents/RoboticsAndROS2-LearnByDoingManipulators/arduinobot_ws/src/arduinobot_remote/src/task_server.cpp
...
CMakeFiles/task_server.dir/src/task_server.cpp.i: cmake_force
	...
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /home/joho/Documents/RoboticsAndROS2-LearnByDoingManipulators/arduinobot_ws/src/arduinobot_remote/src/task_server.cpp > CMakeFiles/task_server.dir/src/task_server.cpp.i
...
CMakeFiles/task_server.dir/src/task_server.cpp.s: cmake_force
	...
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /home/joho/Documents/RoboticsAndROS2-LearnByDoingManipulators/arduinobot_ws/src/arduinobot_remote/src/task_server.cpp -o CMakeFiles/task_server.dir/src/task_server.cpp.s
...
libtask_server.so: /home/joho/Documents/RoboticsAndROS2-LearnByDoingManipulators/arduinobot_ws/install/arduinobot_msgs/lib/libarduinobot_msgs__rosidl_typesupport_fastrtps_c.so
libtask_server.so: /home/joho/Documents/RoboticsAndROS2-LearnByDoingManipulators/arduinobot_ws/install/arduinobot_msgs/lib/libarduinobot_msgs__rosidl_typesupport_fastrtps_cpp.so
libtask_server.so: /home/joho/Documents/RoboticsAndROS2-LearnByDoingManipulators/arduinobot_ws/install/arduinobot_msgs/lib/libarduinobot_msgs__rosidl_typesupport_introspection_c.so
libtask_server.so: /home/joho/Documents/RoboticsAndROS2-LearnByDoingManipulators/arduinobot_ws/install/arduinobot_msgs/lib/libarduinobot_msgs__rosidl_typesupport_introspection_cpp.so
libtask_server.so: /home/joho/Documents/RoboticsAndROS2-LearnByDoingManipulators/arduinobot_ws/install/arduinobot_msgs/lib/libarduinobot_msgs__rosidl_typesupport_cpp.so
libtask_server.so: /home/joho/Documents/RoboticsAndROS2-LearnByDoingManipulators/arduinobot_ws/install/arduinobot_msgs/lib/libarduinobot_msgs__rosidl_generator_py.so
libtask_server.so: /opt/ros/humble/lib/libcomponent_manager.so
libtask_server.so: /opt/ros/humble/lib/libmoveit_move_group_interface.so.2.5.9
libtask_server.so: /home/joho/Documents/RoboticsAndROS2-LearnByDoingManipulators/arduinobot_ws/install/arduinobot_msgs/lib/libarduinobot_msgs__rosidl_typesupport_c.so
libtask_server.so: /home/joho/Documents/RoboticsAndROS2-LearnByDoingManipulators/arduinobot_ws/install/arduinobot_msgs/lib/libarduinobot_msgs__rosidl_generator_c.so
...
libtask_server.so: /opt/ros/humble/lib/libmoveit_common_planning_interface_objects.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_planning_scene_interface.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_move_group_default_capabilities.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_move_group_capabilities_base.so.2.5.9
...
libtask_server.so: /opt/ros/humble/lib/libmoveit_warehouse.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_constraint_sampler_manager_loader.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_plan_execution.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_default_planning_request_adapter_plugins.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_cpp.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_planning_pipeline.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_trajectory_execution_manager.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_planning_scene_monitor.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_robot_model_loader.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_kinematics_plugin_loader.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_rdf_loader.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_collision_plugin_loader.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_ros_occupancy_map_monitor.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libcollision_detector_bullet_plugin.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_butterworth_filter.so.2.5.9
...
libtask_server.so: /opt/ros/humble/lib/libmoveit_collision_distance_field.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_collision_detection_bullet.so.2.5.9
...
libtask_server.so: /opt/ros/humble/lib/libmoveit_dynamics_solver.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libkdl_parser.so
libtask_server.so: /opt/ros/humble/lib/libmoveit_constraint_samplers.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_distance_field.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_kinematics_metrics.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_planning_interface.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_planning_request_adapter.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_planning_scene.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_kinematic_constraints.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_collision_detection_fcl.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_collision_detection.so.2.5.9
...
libtask_server.so: /opt/ros/humble/lib/libmoveit_smoothing_base.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_test_utils.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_trajectory_processing.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_robot_trajectory.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_robot_state.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_robot_model.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_exceptions.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libmoveit_kinematics_base.so
libtask_server.so: /opt/ros/humble/lib/libsrdfdom.so.2.0.7
libtask_server.so: /opt/ros/humble/lib/liburdf.so
libtask_server.so: /opt/ros/humble/lib/x86_64-linux-gnu/libruckig.so
libtask_server.so: /opt/ros/humble/lib/libmoveit_transforms.so.2.5.9
libtask_server.so: /opt/ros/humble/lib/libgeometric_shapes.so.2.3.2
...
libtask_server.so: /opt/ros/humble/lib/libmoveit_utils.so.2.5.9
...
libtask_server.so: CMakeFiles/task_server.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/joho/Documents/RoboticsAndROS2-LearnByDoingManipulators/arduinobot_ws/build/arduinobot_remote/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX shared library libtask_server.so"
